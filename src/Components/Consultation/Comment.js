...
import {
    getConsultationById,
    getConsultationRepliesByReplyId,
    getConsultationRepliesByReplyIdAll, getConsultations, getForumRepliesByReplyId, postConsultation, postForum
...
class Comment extends React.Component{
    ...
    componentDidMount() {
        ...
        getConsultationById(window.location.pathname.split('/')[2]).then((res)=>{
            if(res){
        ...
        getConsultationRepliesByReplyId(window.location.pathname.split('/')[2],0,this.state.size).then((res)=>{
            if(res){
    ...
    render() {
        const {batafsil,comments,consultation,size,current_user,CommentValue}=this.state;
        ...
        const CloseCommentsAll=()=>{
            ...
            getConsultationRepliesByReplyId(window.location.pathname.split('/')[2],0,2).then((res)=>{
                if(res){
                    this.setState({
                        comments:res.data,
                    })
                                ...
                                <Card>
                                             ...
                                             <Col span={24}>
                                                <Card style={{ width: '90%',marginLeft:'5%', marginTop: 16,marginBottom:'20px' }} >
                                                    <Meta
                                                        ...
                                                        title={this.state.consultation.userFullname}
                                                    />
                                                    <br/>
                                                    <h3>
                                                        {this.state.consultation.title}
                                                    </h3>
                                                    <h4 style={{color:'#61666D'}}>
                                                        <h4>{this.state.consultation.content}</h4>

                                                    </h4>
                                                    <br/>
                                                    {
                                                        consultation.tags?consultation.tags.map(item=>{
                                                    ...
                                                    <Row>
                                                        <Col span={18}>
                                                            <Row>
                                                                <Col span={6}>
                                                                    <div style={{color:'#50C878',fontSize:'18px',cursor:'pointer'}}><ArrowUpOutlined />{consultation.replyCount}</div>
                                                                </Col>

                                                                <Col span={6}>
                                                                    <div style={{color:'#61666D',fontSize:'18px',cursor:'pointer'}}><ArrowDownOutlined />{consultation.replyCount}</div>
                                                                </Col>
                                                        ...
                                                        <Col span={6}>
                                                            <Row>
                                                                <Col span={12}>
                                                                    <div style={{color:'#61666D',fontSize:'18px',cursor:'pointer'}}><EyeOutlined />{consultation.viewCount}</div>
                                                                </Col>

                                                                <Col span={12}>
                                                                    <div style={{color:'#61666D',fontSize:'18px',cursor:'pointer'}}><MessageOutlined />{consultation.replyCount}</div>
                                                                </Col>
                                    ...
                                    <Card>
                                        <Card style={{ width: '90%',marginLeft:'5%', marginTop: 25,marginBottom:'20px' }} >
                                            ...
                                            <Button onClick={PostConsultation} className={'dobavit_btn'}>{uzLang?"Qo'shish":enLang?"Add to":"Добавить"}</Button>
