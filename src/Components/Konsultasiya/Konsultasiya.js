...
class Konsultasiya extends React.Component{
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return(
            <React.Fragment>
                <div className="main_konsultasiya">
                    <p  className={'nasha_title'} >{uzLang?"O'z vaqtida konsultatsiyalar":enLang?"Timely consultations":"Своевременные консультации"}</p>
                    <p className={'nasha_text'}>{uzLang?"To'g'ridan-to'g'ri kasbingiz bilan bog'liq ba'zi sohalarda maslahat oling":enLang?"Get advice in some areas related directly to your profession":"Получите консультацию в некоторых направлениях связанных непосредственно с вашей профессией"} </p>
                    <div className="container">
                        <Slider {...settings}>
                            {
                                consultations?consultations.map(function (item) {
                                    var date= new Date(item.createAt);


                                    return <div style={{width:'100%',position:'relative'}}>
                                        <Card style={{ width: '90%',height:'90%',marginLeft:'5%', marginTop: 16,marginBottom:'100px' }} >
                                            <Meta
                                                width={'100%'}
                                                avatar={
                                            ...
                                            <div style={{position:'relative',width:'90%'}}>
                                                ...
                                                <p style={{boxSizing:'border-box'}}>
                                                    {item.content.slice(0,40)}<br/>
                                                    {item.content.slice(40,80)}
                                                </p>
                                            </div>
                                            <br/>
                                            {
