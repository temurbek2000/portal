...
class All extends React.Component{
    ...
    render() {
        const {batafsil,isModalVisible}=this.state;
        const {forums,uzLang,enLang}=this.props;
        const callback=(key)=>{
            console.log(key)
        }
        const Batafsil=()=>{
                                        ...
                                        <Row>
                                            ...
                                            <Col span={6}>
                                                <Row>
                                                    ...
                                                    <Col span={12}>
                                                        <div style={{color:'#61666D',fontSize:'18px',cursor:'pointer'}}><Link to={'/add/'+item.id}><MessageOutlined />{item.replyCount}</Link></div>
                                                    </Col>
