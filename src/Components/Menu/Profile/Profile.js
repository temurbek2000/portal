...
import {Row,Col,Card,Form,Input,Button,Select,Tooltip,Upload,message} from 'antd';
                ...
                <Row>
                    <Col md={4} sm={24} xs={24}>
                     <Card style={{backgroundColor:'lightgray'}}>
                         <h3 style={{cursor:'pointer'}}>Mening Profilim</h3>
                         <h3 style={{cursor:'pointer',color:'red'}}>Chiqish</h3>
                     </Card>
                    </Col>
                                ...
                                >
                                    <Row>
                                        ...
                                        <Col md={12} sm={24} xs={24}>
                                            ...
                                            >
                                                <Select onChange={GetDiscricts}>
                                                    {
                                                        this.state.regions?this.state.regions.map(item=>{
                                                            return <Select.Option value={item.id}>{item.nameUz}</Select.Option>
                                                        }):''
                                                    }
